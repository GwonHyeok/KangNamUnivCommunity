 ...
 */
public class MarketBoardDetailActivity extends BaseBoardDetailActivity implements View.OnClickListener {
    ...
    private void setContent() {
        new AsyncTask<Void, Void, JSONObject>() {
            ...
            protected void onPreExecute() {
                progressDialog = new ClearProgressDialog(MarketBoardDetailActivity.this);
                progressDialog.show();
            }
                    ...
                    fileImageView.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            ActivityOptionsCompat options = ActivityOptionsCompat.makeSceneTransitionAnimation(
                                    MarketBoardDetailActivity.this, v, "imagecollection_transition");
                            ActivityCompat.startActivity(MarketBoardDetailActivity.this, intent, options.toBundle());
                        }
                    });
