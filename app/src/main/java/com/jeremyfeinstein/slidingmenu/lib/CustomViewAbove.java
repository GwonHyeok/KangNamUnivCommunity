...
public class CustomViewAbove extends ViewGroup {
    ...
    public interface OnPageChangeListener {
         ...
         *                             Page position+bg_stndentground_1 will be visible if positionOffset is nonzero.
         * @param positionOffset       Value from [0, bg_stndentground_1) indicating the offset from the page at position.
     ...
     * @param position     Position index of the first page currently being displayed.
     *                     Page position+bg_stndentground_1 will be visible if positionOffset is nonzero.
     * @param offset       Value from [0, bg_stndentground_1) indicating the offset from the page at position.
